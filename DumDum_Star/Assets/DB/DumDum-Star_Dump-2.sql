...
INSERT INTO `choom` VALUES (1,'Chrome','Chromazon','MoreChrome@nc.com','Dum-Dum'),(2,'SoloOfFortune','Master@Solo','solo-to-solo@nc.com','David'),(3,'SLHand','rock-live','fan-mail@nc.com','Johnny'),(4,'BH-Solo','solo-ruler-master-race','bh-mail@nc.com','Morgan'),(5,'Storm','Is','That@gmail.com','Locked15'),(6,'Test1','TestToTest','Test1@mail.com','Choom'),(7,'Test2','Test','Test2@mail.com','Choom');
...
INSERT INTO `client` VALUES (1,2),(2,3),(3,4),(4,7);
...
INSERT INTO `corporation` VALUES (1,'Arasaka',890000000000.00,595000),(2,'Militech',1200000000000.00,647000),(3,'Zetatech',NULL,12000),(4,'Techtronika Ltd.',NULL,NULL),(5,'Malorian Firearms, Inc',NULL,25000),(6,'Biotechnica',NULL,36256),(7,'Night Corporation',464000000000.00,38648),(8,'Kiroshi Opticals',NULL,24759);
...
INSERT INTO `cyber_ware` VALUES (1,4,7,2,13,0,'Sandevistan Falcon MK5',43749.99,'https://static.wikia.nocookie.net/cyberpunk/images/0/07/SandevistanC4MK5_Icon_CP2077.png',0.37,NULL),(2,4,7,1,4,0,'Hashishin Berserk MK1',894766.87,'https://static.wikia.nocookie.net/cyberpunk/images/0/0e/SandevistanC1_Icon_CP2077.png',0.63,NULL),(3,2,2,4,1,0,'Eagle-Eye NK2',13479.99,NULL,0.15,'Взгляните на мир по-новому.'),(4,1,4,3,5,0,'Pain Editor \'StreetKid\' MK3',27899.99,'https://static.wikia.nocookie.net/cyberpunk/images/6/62/PainEditor_Icon_CP2077.png',0.15,'Этот имплант стал причиной резкого повышения уровня смертности на улицах.'),(5,2,2,8,4,1,'Kiroshi Optics MK2',2000.00,'https://static.wikia.nocookie.net/cyberpunk/images/f/fb/KiroshiOptics_Icon_CP2077.png',0.05,'Лучшая оптика за свою цену.');
...
--
-- Table structure for table `cyber_ware_to_order`
--

DROP TABLE IF EXISTS `cyber_ware_to_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cyber_ware_to_order` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cyber_ware_id` int NOT NULL,
  `order_id` int NOT NULL,
  `count` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `cyber_in_order_limit` (`cyber_ware_id`),
  KEY `order_in_cyber_limit` (`order_id`),
  CONSTRAINT `cyber_in_order_limit` FOREIGN KEY (`cyber_ware_id`) REFERENCES `cyber_ware` (`id`),
  CONSTRAINT `order_in_cyber_limit` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`),
  CONSTRAINT `cyber_ware_to_order_chk_1` CHECK ((`count` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cyber_ware_to_order`
--

LOCK TABLES `cyber_ware_to_order` WRITE;
/*!40000 ALTER TABLE `cyber_ware_to_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `cyber_ware_to_order` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-12-13  6:33:56
